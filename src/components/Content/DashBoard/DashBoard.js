...
class DashBoard extends Component {
  ...
  async componentDidMount() {
    ...
    if (token) {
      ...
      const category =  callApi('admin/reports/products', 'GET', null, token);
      const income =  callApi('admin/reports/income', 'GET', null, token);
      const contact =  callApi('admin/reports/contacts', 'GET', null, token);
